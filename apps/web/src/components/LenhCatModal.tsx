...
export function LenhCatModal({ isOpen, onClose, editId }: { isOpen: boolean; onClose: () => void; editId?: string | null }) {
  ...
  return (
    <div className="fixed inset-0 md:left-[72px] md:w-[calc(100%-72px)] z-[60] flex items-center justify-center bg-[#2B4C3E]/80 backdrop-blur-sm p-0 md:p-2 animate-fade-in">
      <div
        className="bg-[#2B4C3E] rounded-none md:rounded-xl shadow-2xl w-full h-full md:w-full md:h-[97vh] max-w-none overflow-hidden flex flex-col animate-slide-up border-0 md:border-4 border-[#2B4C3E]"
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
                ...
                <div className="flex-1 bg-orange-50 border-2 border-orange-300 p-3 rounded-lg flex flex-col md:flex-row items-start md:items-center gap-3 shadow-sm w-full">
                  ...
                  <div className="flex items-center gap-1 w-full md:w-auto">
                    <span className="text-xs font-bold text-orange-700">Đơn giá thực tế:</span>
                    <input 
                      type="number" min={0}
                      placeholder="0" 
