              ...
              <div className="mt-5 flex flex-col items-center gap-3 w-full">
                ...
                <div className="flex flex-col items-center gap-2 mt-1">
                  ...
                  <div className="flex items-center gap-3 opacity-40 grayscale hover:grayscale-0 transition-all duration-300">
                    <svg viewBox="0 0 38 12" className="h-3" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg viewBox="0 0 24 16" className="h-4" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg viewBox="0 0 40 30" className="h-4" xmlns="http://www.w3.org/2000/svg">
