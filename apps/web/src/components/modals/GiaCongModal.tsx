                ...
                <div key={khau.id} className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                  ...
                  <div className="bg-slate-50 p-4 border-b border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <select
                      ...
                      className="w-full md:w-64 px-3 py-2 border border-slate-300 rounded-lg text-sm font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-500"
                    >
                            ...
                            {chiTiet.map((sz: any, sIdx: number) => (
                              <div key={sIdx} className="w-16">
                                ...
                                <input
                                  ...
                                  className="w-full text-center py-1.5 border border-slate-300 rounded-lg text-sm font-bold text-slate-700 focus:ring-2 focus:ring-sky-500/50 outline-none"
                                />
                              </div>
                            ))}
                          </div>
                          
                          <div className="w-full md:w-24 text-right pt-4 md:pt-0">
                            <div className="text-[10px] font-bold text-slate-400 uppercase">Tổng màu</div>
                            <div className="text-sm font-black text-emerald-600">{totalMau}</div>
                          </div>
                        </div>
                      );
                    })}
