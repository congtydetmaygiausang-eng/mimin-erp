...
const NAV: NavItem[] = [
  ...
  },
  {
    label: "🏭 Sản Xuất & Kế hoạch", icon: Factory, isGroup: true, subItems: [
      ...
      { href: "/to-cat-work", label: "✂️ Tổ Cắt – Việc của tôi", icon: Scissors, permModule: "lenh-cat" },
      ...
      { href: "/to-ht-work", label: "🦺 Hoàn Thiện – Việc của tôi", icon: ClipboardList, permModule: "hoan-thien" },
