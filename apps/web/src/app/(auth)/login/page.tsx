...
import { DEMO_USERS, supabase } from "@/lib/supabase/client";
          ...
          <div className="card p-6 md:p-8 w-full max-w-md mx-auto shadow-2xl">
            ...
            <div className="relative mt-6 mb-4">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-transparent px-2 text-white/50 backdrop-blur-sm rounded-full">Hoặc</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-white/10 rounded-lg hover:bg-white/5 transition-colors text-sm font-medium mb-6"
            >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-white/70 gap-2">
              <Link href="/forgot-password" className="hover:text-white transition-colors">
                Quên mật khẩu?
              </Link>
              <div className="flex items-center gap-1">
                <span>Chưa có tài khoản?</span>
                <Link href="/register" className="text-brand-400 font-medium hover:text-brand-300 transition-colors">
                  Đăng ký ngay
                </Link>
              </div>
            </div>
