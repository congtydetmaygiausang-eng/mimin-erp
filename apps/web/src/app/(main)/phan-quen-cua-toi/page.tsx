...
const ROLE_DESCRIPTIONS: Record<Role, string> = {
  ...
  supplier: "Nhà cung cấp - Xem đơn được giao và cập nhật tiến độ sản xuất",
  workshop_customer: "Khách hàng xưởng - Quản lý đơn hàng thuộc xưởng của mình",
  buyer_customer: "Khách mua hàng - Đặt hàng và theo dõi giao hàng của mình",
