      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            {mayCreate && (
              <><Link href="/mang-luoi-san-xuat/rfq" className="btn-secondary inline-flex items-center gap-2">RFQ</Link><Link href="/mang-luoi-san-xuat/xep-hang" className="btn-secondary inline-flex items-center gap-2">Xếp hạng</Link><Link href="/mang-luoi-san-xuat/tim-kiem" className="btn-secondary inline-flex items-center gap-2"><Search className="w-4 h-4" /> Tìm tự động</Link><button onClick={openCreate} className="btn-primary inline-flex items-center gap-2">
