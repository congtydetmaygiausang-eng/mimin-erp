                    ...
                    <tr key={n.maNV} className="border-b last:border-0 hover:bg-white/30 dark:hover:bg-white/5" style={{ borderColor: "var(--border)" }}>
                      ...
                      <td className="p-3">
                        <div className="flex items-center gap-2">
                          <Avatar name={n.hoTen} size="sm" />
                          <div>
                            <div className="font-medium">{n.hoTen}</div>
                      ...
                      <td className="p-3 text-center">
                        <div className="flex items-center justify-center gap-1">
                          <button onClick={() => setShowLuong(n)} className="text-[10px] px-1.5 py-0.5 rounded bg-emerald-500/15 text-emerald-700 hover:bg-emerald-500/25" title="Bảng lương">
                            <Wallet className="w-3 h-3" />
                          </button>
                          <button onClick={() => setShowForm({ mode: "edit", nv: n })} className="text-[10px] px-1.5 py-0.5 rounded bg-sky-500/15 text-sky-700 hover:bg-sky-500/25">
                            <Edit2 className="w-3 h-3" />
                          </button>
                          <button onClick={() => handleDelete(n)} className="text-[10px] px-1.5 py-0.5 rounded bg-red-500/15 text-red-700 hover:bg-red-500/25">
          ...
          {filtered.map((n) => {
            ...
            return (
              <div key={n.maNV} className="card p-3 flex items-center gap-3">
                <Avatar name={n.hoTen} size="md" />
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-sm">{n.hoTen}</div>
