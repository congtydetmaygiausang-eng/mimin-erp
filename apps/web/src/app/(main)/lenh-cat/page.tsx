...
function StatCard({ icon, label, value, sub, color }: {
  ...
  const colorMap: Record<string, string> = {
    ...
    amber: "from-amber-500/10 to-orange-500/10 text-amber-700 dark:text-amber-400",
    emerald: "from-emerald-500/10 to-green-500/10 text-emerald-700 dark:text-emerald-400",
    sky: "from-sky-500/10 to-cyan-500/10 text-sky-700 dark:text-sky-400",
  };
  return (
