function normalizeEmployeeRecord(record) {
  return {
    ...
    ngayVao: record.ngay_vao || record.ngay_vao_lam || record.ngayVao || record.ngayVaoLam,
    ngayVaoLam: record.ngay_vao_lam || record.ngay_vao || record.ngayVaoLam || record.ngayVao,
...
function toSupabaseEmployeeRecord(payload) {
  return {
    ...
    ngay_vao: payload.ngayVao || payload.ngayVaoLam || null,
    ngay_vao_lam: payload.ngayVaoLam || payload.ngayVao || null,
