function normalizeEmployeeRecord(record) {
  return {
    ...
    sdt: record.sdt,
    email: record.email,
    luongCung: Number(record.luong_cung ?? record.luongCung ?? record.luong_cb ?? record.luongCB ?? 0),
    luongCB: Number(record.luong_cb ?? record.luongCB ?? record.luong_cung ?? record.luongCung ?? 0),
    ...
    ngayVao: record.ngay_vao || record.ngayVao || record.ngay_vao_lam || record.ngayVaoLam || '',
    facebookUrl: record.facebook_url ?? record.facebookUrl ?? '',
...
function toSupabaseEmployeeRecord(payload) {
  return {
    ...
    luong_cung: Number(payload.luongCung ?? payload.luongCB ?? 0),
    ...
    luong_cb: Number(payload.luongCB ?? payload.luongCung ?? 0),
