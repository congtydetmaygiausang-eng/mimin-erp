...
export interface AgentPersona {
  ...
  greeting: string;
  // Lời chào NGẮN cho lần mở chat sau (đã từng nhắn tin với agent này rồi) -
  // không lặp lại giới thiệu đầy đủ, đúng chất riêng từng agent thay vì 1
  // câu chung cho cả 6 (agents-chat/page.tsx quyết định dùng greeting hay
  // greetingShort dựa trên "đã từng chat với agent này chưa").
...
AGENT_PERSONAS["mavis"] = {
  ...
  greetingShort: "Em đây anh 👋 Hôm nay mình cần điều phối việc gì trước ạ?",
};
...
AGENT_PERSONAS["minh"] = {
  ...
  greetingShort: "Em đây anh 👋 Cắt, May hay QC - mình kiểm tra khâu nào trước?",
};
...
AGENT_PERSONAS["lan"] = {
  ...
  greetingShort: "Em đây anh 👋 Hôm nay mình kiểm tra tồn kho, đơn bán hay mã hàng trước?",
};
...
AGENT_PERSONAS["ha"] = {
  ...
  greetingShort: "Em đây anh 👋 Hôm nay mình xem công nợ, lương hay báo cáo tài chính trước ạ?",
};
...
AGENT_PERSONAS["vy"] = {
  ...
  greetingShort: "Em đây anh 👋 Có đơn hàng hay khách hàng nào cần em hỗ trợ không ạ?",
};
...
AGENT_PERSONAS["mimin-help"] = {
  ...
  greetingShort: "Em đây anh 👋 Mình cùng tìm giải pháp hay tối ưu phần nào hôm nay?",
};
